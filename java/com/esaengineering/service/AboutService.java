...
public class AboutService {
   ...
   public void saveContents(ContentAbout newContent){
    ...
    if (contents.isEmpty()) {
        about = new ContentAbout();

    } else {
       about = contents.get(0);
    }
   ...
   public String getStory() {
        return repository.findAll().get(0).getStory();
    }

    public void saveStory(String story) {
        ContentAbout about = repository.findAll().get(0);
        about.setStory(story);
        repository.save(about);
    }
    public String getHeading1() {
        return repository.findAll().get(0).getHeading1();
    }
    ...
    public String getHeading2() {
        return repository.findAll().get(0).getHeading2();
    }
    ...
    public String getParagraph1() {
        return repository.findAll().get(0).getParagraph1();
    }

    public String getParagraph2() {
        return repository.findAll().get(0).getParagraph2();
    }
    public String getParagraph3() {
        return repository.findAll().get(0).getParagraph3();
    }
    ...
    public String getSpecialist1Name() {
        return repository.findAll().get(0).getSpecialist1Name();
    }
    public String getSpecialist2Name() {
        return repository.findAll().get(0).getSpecialist2Name();
    }
    ...
    public String getSpecialist1Biography() {
        return repository.findAll().get(0).getSpecialist1Biography();
    }
    public String getSpecialist2Biography() {
        return repository.findAll().get(0).getSpecialist2Biography();
    }
    ...
    public String getSpecialist1Position() {
        return repository.findAll().get(0).getSpecialist1Position();
    }

    public String getSpecialist2Position() {
        return repository.findAll().get(0).getSpecialist2Position();
    }
